                                ...
                                <div class="flex items-center my-1">
                                    <a class="w-6 text-gray-700 hover:text-orange-600"
                                        ...
                                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M13.9868 5L12.9934 8.70743M11.8432 13L10.0132 19.8297"
                                                stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" />
                                            <path
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-sm font-medium">
                                        <span class="text-green-700">B.E. (INFORMATION TECHNOLOGY)</span>, PIMPRI
                                        CHINCHWAD
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-sm font-medium"><span class="text-green-700">HSC</span>, RAJARSHI
                                        SHAHU
                                        COLLEGE, LATUR.</p>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-sm font-medium"><span class="text-green-700">SSC</span>,
                                        DNYANESHWAR HIGH
                                        SCHOOL, LATUR.</p>
                        ...
                        <div class="py-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="font-normal text-sm text-gray-700 mb-1 pl-2">A platform to sell as well
                                        as to
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="font-normal text-sm text-gray-700 mb-1 pl-2">it’s a web application which
                                        helps you to book your slot for your car just like booking a movie ticket from
                                        home.
                                    </p>
                                </div>
